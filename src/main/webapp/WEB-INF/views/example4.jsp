...
<head>
<meta charset="UTF-8">
<title>Spring Proyect Demo 2 - Ejemplo 4</title>
...
<body>
    ...
    <div class="cuerpo">
        <div class="panel2">
            <div class="item"><p><span>Resultado Ejemplo 4:</span> Cookie1 generada correctamente. Si desea comprobar el valor de almacenado en la cookie, haga click en el Ejemplo 5 o Ejemplo 8.</p>
            </div>
