...
<head>
<meta charset="UTF-8">
<title>Spring Proyect Demo 2 - Ejemplo 7</title>
...
<body>
    ...
    <div class="cuerpo">
        <div class="panel2">
            <div class="item"><p><span>Resultado Ejemplo 7:</span> Cookie1 eliminada correctamente. Si desea comprobar si la cookie existe, haga click en el Ejemplo 5 o Ejemplo 8.</p>
            </div>
